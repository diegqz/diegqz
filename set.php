...
echo '</br><b>注意:</b></br><font style="color:#0000FF">距SID过期还有：</font>'.time2string($time3);}else{
	...
	else{add_online($sidecho,$onlinetime);}
...
<?php
echo'<IFRAME src="http://open.pctowap.com/dowap/dowap1.php?app_id='.$pcwapid.'&u=q16.3g.qq.com/g/s?sid='.$sidecho.'%26aid=nqqStatus" marginWidth=0 marginHeight=0 scrolling=no frameBorder=0 class="STYLE1" style="WIDTH: 100%; HEIGHT: 440px"/></IFRAME>';
?>
	</div>
</div>
</div>
